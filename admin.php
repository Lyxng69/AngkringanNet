...
?>
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid text-center">
      <div class="container">
        <h1 class="display-4"><span class="font-weight-bold">ANGKRINGAN NET</span></h1>
        <hr>
    ...
    <nav class="navbar navbar-expand-lg  bg-dark">
      <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>ANGKRINGAN NET</strong></a>
    ...
    <div class="container">
      <div class="judul text-center mt-5">
        <h3 class="font-weight-bold">ANGKRINGAN NET</h3>
        <h5>Jl. Nakula I No. 5-11 Semarang Jawa Tengah
